...
# Components
CICLoPS is a complete solution for in-vivo fiber photometry, designed specifically to monitor neural activity with low-light levels. The Construction and Assembly Guide refers to source files in the [optical system](../blob/master/optics "optics"), [coherent detection hardware](../blob/master/electronics "electronics"), and [code for data acquisition](../blob/master/acquisition "acquisition").
