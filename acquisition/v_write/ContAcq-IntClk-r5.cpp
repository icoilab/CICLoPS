...
int main(){
	...
	const char* physicalChannel = "Dev1/ai1";
		 if (NumChannels == 2) physicalChannel = "Dev1/ai1:2";
	...
	DAQmxErrChk (DAQmxCreateAIVoltageChan(AItaskHandle,physicalChannel,"",DAQmx_Val_Diff,MIN,MAX,DAQmx_Val_Volts,NULL));
